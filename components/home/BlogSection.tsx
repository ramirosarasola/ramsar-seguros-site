          ...
          {ARTICLES.map((article, i) => (
            <Link
              ...
              className={[
                ...
                'transition-shadow duration-[120ms] hover:shadow-elevation-3',
                /* mobile: hide 3rd article */
                i === 2 ? 'hidden md:block' : '',
              ].join(' ')}
            >
              {/* Image placeholder */}
              <div className="aspect-video bg-neutral-200 relative flex-shrink-0">
                <div
              ...
              <div className="p-4 flex flex-col gap-2">
                <h3 className="font-sans font-semibold text-[15px] leading-[1.28] text-neutral-900 group-hover:text-primary-700 transition-colors duration-[120ms]">
                  {article.title}
                </h3>
                ...
                <div className="flex items-center gap-1.5 mt-1">
                  <div className="w-5 h-5 rounded-full bg-neutral-200 flex-shrink-0" aria-hidden="true" />
