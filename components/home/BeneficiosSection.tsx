...
const STEPS = [
  {
    ...
    description: 'Marca, modelo, año y tu código postal. Solo lo esencial, nada más.',
  },
  {
    num: '02',
    Icon: RefreshCw,
      ...
      <section id="como-funciona" className="bg-neutral-50 py-20 md:py-20">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 relative">
            ...
            {STEPS.map((step) => (
              <div key={step.num} className="flex flex-col items-center text-center md:items-start md:text-left relative">
                {/* Decorative number */}
                <span
                ...
                >
                  <step.Icon size={28} strokeWidth={1.75} className={step.iconColor} aria-hidden="true" />
                </div>
          ...
          <div className="flex flex-col items-center mt-10 gap-2">
            <p className="font-sans text-[16px] text-neutral-600">¿Listo para empezar?</p>
            <Link
              href="/seguros-de-auto/cotizar"
              className="inline-flex items-center gap-1.5 bg-primary-700 text-white font-sans font-semibold text-[14px] px-6 py-3 rounded-sm no-underline hover:bg-primary-600 active:bg-primary-800 transition-colors duration-[120ms] shadow-elevation-1"
            >
              Cotizá gratis ahora →
            </Link>
          </div>
