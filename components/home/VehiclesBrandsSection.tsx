      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-16">
        ...
        <div className="mb-8">
          ...
          <p className="font-sans text-[16px] text-neutral-500 mt-2 max-w-[600px]">
            Encontrá el seguro ideal según tu vehículo. Cada marca y modelo tiene características
            que afectan el precio y las coberturas disponibles.
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
          {BRANDS.map((brand) => (
            ...
            >
              ...
              <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center font-mono text-[10px] text-neutral-500 flex-shrink-0 border border-neutral-100">
                {initials(brand.name)}
              </div>
              <span className="font-sans font-semibold text-[11px] text-neutral-900 text-center leading-tight group-hover:text-primary-700 transition-colors duration-[120ms]">
                {brand.name}
              </span>
        ...
        <div className="mt-12 pt-6 border-t border-neutral-200 max-w-[640px]">
          ...
          <p className="font-sans text-[15px] text-neutral-700 leading-relaxed mb-3">
            El precio y las coberturas de un seguro de auto dependen de varios factores relacionados
            con el vehículo: su valor de mercado, la disponibilidad de repuestos, el índice de
            siniestralidad de la marca y el costo de reparación.
          </p>
          <p className="font-sans text-[15px] text-neutral-700 leading-relaxed">
            Por eso, un seguro para un Toyota Corolla no cuesta lo mismo que uno para un Volkswagen
            Gol. En Ramsar Seguros podés cotizar por marca y modelo para obtener el precio más preciso.
          </p>
        </div>
      </div>
    </section>
