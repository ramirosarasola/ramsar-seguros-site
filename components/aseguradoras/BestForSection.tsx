...
function PersonaCardItem({ card }: { card: PersonaCard }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-elevation-1 p-8 flex flex-col hover:shadow-elevation-2 hover:-translate-y-0.5 transition-all duration-150">
      <div className="w-12 h-12 bg-primary-50 rounded-lg flex items-center justify-center mb-5 shrink-0">
        <Icon
          size={20}
          strokeWidth={2}
      ...
      <p className="text-base text-neutral-600 mt-3 flex-1">
        {card.description}
      </p>
      <Link
        href={card.linkHref}
      ...
      <div className="max-w-300 mx-auto px-6 lg:px-16">
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <p className="text-lg text-neutral-500 mt-3">
            Identificá rápidamente si {insurer.name.split(" ")[0]} es la mejor
            opción para tu perfil de conductor.
          </p>
        </div>
