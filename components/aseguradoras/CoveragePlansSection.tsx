  ...
  return (
    ...
    >
      ...
      <p
        className={[
          "text-sm mt-0.5",
          isRec ? "text-primary-600" : "text-neutral-500",
        ].join(" ")}
      >
        {plan.tagline}
      </p>
      ...
      <div className="max-w-300 mx-auto px-6 lg:px-16">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <p className="text-lg text-neutral-500 mt-3">
            {insurer.name.split(" ")[0]} ofrece tres niveles de cobertura para
            auto. Seleccioná el plan que mejor se adapta a tu vehículo y
            presupuesto.
          </p>
        </div>
